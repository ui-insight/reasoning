...
# 4_sft.py
#
# Let's fine-tune using unsloth.ai with 4-bit QLoRA
#
# Luke Sheneman
...
#DATA_FILE = "full_training_set.jsonl"  # Local training data file
DATA_FILE = "synthetic_gsm8k_formatted2.jsonl"  # Local training data file
#DATA_FILE = "synth_data.jsonl"  # Local training data file
